...
public class RestaurantTests {
    ...
    public void resturantTest(){
        Restaurant nandos = new Restaurant("Nandos","http://nados.image.jpg");
        assertEquals(nandos.getName(), "Nandos");
    }
    @Test
    public void imageurlTest(){
        Restaurant nandos = new Restaurant("Nandos", "https://www.worcesternews.co.uk/resources/images/11399294.jpg?display=1&htype=52&type=responsive-gallery");
